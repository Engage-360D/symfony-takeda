...
class EmailConfirmationListener implements EventSubscriberInterface
{
    ...
    public function onRegistrationSuccess(UserEvent $event)
    {
        ...
        $this->session->set('engage360d_takeda_send_confirmation_email/email', $user->getEmail());
    }

    public function sendConfirmationEmailMessage(UserInterface $user)
    {
        $confirmationUrl = $this->router->generate(
          'engage360d_takeda_registration_confirm',
        ...
        $renderedTemplate = $this->templating
          ->render(
            'Engage360dTakedaBundle:Account:confirmation_email.txt.twig',
            array(

...
class UserController extends Controller
{
    ...
    {
        return $this->render('Engage360dTakedaBundle:User:login.html.twig', array());
    }
    ...
    public function registrationAction(Request $request)
    {
        ...
        //$form = $this->container->get("engage360d_takeda.form.registration");
        //$form->setData($user);

        return $this->container->get('templating')->renderResponse('Engage360dTakedaBundle:User:registration.html.twig', array(
